...
import com.wxd.my_mall.mbg.model.SmsCouponHistory;
import com.wxd.my_mall.services.SmsCouponHistoryService;
...
public class SmsCouponHistoryController {
    ...
    @ResponseBody
    public Response<CommonPage<SmsCouponHistory>> list(@RequestParam(value = "couponId", required = false) Long couponId,
        ...
        return Response.success(CommonPage.restPage(historyList));
    }
}
