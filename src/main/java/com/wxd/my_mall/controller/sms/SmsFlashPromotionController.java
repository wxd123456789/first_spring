...
import com.wxd.my_mall.mbg.model.SmsFlashPromotion;
import com.wxd.my_mall.services.SmsFlashPromotionService;
...
public class SmsFlashPromotionController {
    ...
    @ResponseBody
    public Response create(@RequestBody SmsFlashPromotion flashPromotion) {
    ...
    public Object getItem(@PathVariable Long id) {
        ...
        return Response.success(flashPromotion);
    }
    ...
    public Object getItem(@RequestParam(value = "keyword", required = false) String keyword,
        ...
        return Response.success(CommonPage.restPage(flashPromotionList));
    }
}
